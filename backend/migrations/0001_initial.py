    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField()),
                ('is_completed', models.BooleanField(default=False)),
                ('goal', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='subgoals', to='backend.goal')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=150)),
                ('description', models.TextField()),
                ('attribute', models.CharField(choices=[('knowledge', 'Knowledge'), ('discipline', 'Discipline'), ('energy', 'Energy'), ('charisma', 'Charisma'), ('stress', 'Stress')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('knowledge', 'Knowledge'), ('discipline', 'Discipline'), ('energy', 'Energy'), ('charisma', 'Charisma'), ('stress', 'Stress')], max_length=20)),
